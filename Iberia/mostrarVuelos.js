        ...
        if(i < 5){
            ...
            if(contador == vuelo.asientos+1){  //el pasillo corresponde cuando se 
                ...
                if(checkseat(asiento) == false){ // si el asiento está libre (false).
                    document.writeln("<td class = 'a' id = '"+i+""+abc.charAt(x)+"I'><div class = 'Pasiento'></div> </td>")
                }else if (checkseat(asiento) == true){  //si el asiento está ocupado (true)
                    document.writeln("<td class = 'a' id = '"+i+""+abc.charAt(x)+"I'> <div class = 'asientoOcup'></div> </td>")
                }
            }    
            contador++;
        }
            ...
            if(contador == vuelo.asientos+1){
                ...
                if(checkseat(asiento) == false){ // si el asiento está libre (false).
                    document.writeln("<td class = 'a' id = '"+i+""+abc.charAt(x)+"I'><div class = 'asiento'></div></td>")
                }else if (checkseat(asiento) == true){  //si el asiento está ocupado (true)
                    document.writeln("<td class = 'a' id = '"+i+""+abc.charAt(x)+"I'><div class = 'asientoOcup'></div></td>")
                }   
            }  
